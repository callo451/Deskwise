...
const StyledActionButton: React.FC<StyledActionButtonProps> = ({ to, text }) => {
  return (
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  .cssbuttons-io-button {
    background: #a370f0; /* Slightly adjusted purple */
    color: white;
    font-family: inherit;
    padding: 0.35em;
    padding-left: 1.2em;
    font-size: 0.875rem; /* Match text-sm (14px) */
  ...
  .cssbuttons-io-button:hover {
     background: #7b52b9; /* Darker purple on hover */
  }
